<template>
    <nav id="main-navigation" role="navigation" class="navigation">
        ...
        <ul ref="menu" class="navigation__group navigation__group--main">
            ...
            <navigation-item :to="routes.packages" @navigate="closeNavigation">
                {{ $t('ui.navigation.packages') }}<span class="navigation__item-badge" v-if="packageChanges > 0">{{ packageChanges }}</span>
            </navigation-item>
            <navigation-item :to="routes.maintenance" v-if="isGranted(scopes.UPDATE)" @navigate="closeNavigation">
                {{ $t('ui.navigation.maintenance') }}<span class="navigation__item-badge" v-if="hasDatabaseChanges || hasDatabaseWarning || hasDatabaseError">1</span>
            </navigation-item>
            <li class="navigation__item navigation__item--main navigation__item--children">
            ...
            <li class="navigation__item navigation__item--main navigation__item--children navigation__item--icon">
                <button>
                    <!-- prettier-ignore -->
        ...
        phpinfo() {
            ...
            if (popup) {
                ...
                popup.document.write(
                    '<p class="phpinfo__loading" style="display: flex; justify-content: center; align-items: center; min-height: 100vh; font: 4vmin -apple-system, system-ui, &quot;Segoe UI&quot;, Roboto, Oxygen-Sans, Ubuntu, Cantarell, &quot;Helvetica Neue&quot;, sans-serif;">',
                );
